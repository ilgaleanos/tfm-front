                ...
                <Container disableGutters maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'block', md: 'flex' } }}>
                            ...
                            <button className="boton-primario" key="permisos" onClick={() => { navegar('/permisos') }} sx={{ my: 2, display: 'block' }}>
                                <Box sx={{ display: { xs: 'none', md: 'inline' } }}><i className="fas fa-user-shield"></i></Box> &nbsp; Permisos
                            </button>
